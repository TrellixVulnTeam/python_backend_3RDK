...
def task1():
    ...
    query = "SELECT department, COUNT(department)FROM moma_works GROUP BY department ORDER BY COUNT(department) DESC;"  # TODO task 1
...
def task2():
    ...
    query = "SELECT classification, COUNT(classification) from moma_works GROUP BY classification HAVING COUNT(classification) > 100 ORDER BY COUNT(classification) DESC;"  # TODO task 2
...
def task5():
    ...
    title = "Artwork sold by date original artwork acquired"  # TODO task 5
    query = """
